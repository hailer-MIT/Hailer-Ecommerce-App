    ...
    >
      ...
      >
        ...
        <Stack rowGap={"1rem"} padding={"1rem"}>
          ...
          <Typography sx={labelStyles}>Mekelle, Tigray, Ethiopia</Typography>
          <Typography sx={labelStyles}>hailomasegede@gmail.com</Typography>
          <Typography sx={labelStyles}>+251991600289</Typography>
        </Stack>
      ...
      <Stack alignSelf={"center"}>
        <Typography color={"GrayText"}>
          &copy; Hailer Mern Shop {new Date().getFullYear()}. All rights
          reserved
        </Typography>
      </Stack>
    </Stack>
